        ...
        <CardContent> 
          <form autoComplete="off">
            <div className="grid gap-6 max-w-full">
              ...
              <div className="after:border-border relative text-center text-fluid-xs after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
                ...
                <div className="grid gap-3">
                  <div className="flex items-center">
                    ...
                    <Link
                      ...
                      className="ml-auto text-fluid-xs underline-offset-4 hover:underline"
                    >
