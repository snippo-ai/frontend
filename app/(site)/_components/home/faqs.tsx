...
const Faqs: React.FC = () => {
  return (
    <section className="w-full px-4 py-16 flex flex-col items-center relative overflow-hidden">
      {/* Animated Gradient Background on the Right */}
      ...
      <Container>
        <SectionHeading
          as="h2"
          subtitle="Answers to common questions about Snippo."
        >
        ...
        <Accordion
          type="single"
          collapsible
          className="w-full rounded-2xl bg-card/80 border shadow-md divide-y z-10 relative"
        >
          {faqs.map((faq) => (
