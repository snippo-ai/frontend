...
export const metadata: Metadata = {
  ...
  description: "Manage your account security, update passwords, enable two-factor authentication, and review active sessions for enhanced protection.",
  keywords: ["security", "password", "2FA", "account settings", "privacy", "authentication"],
  robots: {
